"""
File which executes slightly adjusted Schoenmakers et al. (2013) upper bound approach to pricing a Bermudan Max Call option, with possibly multiple exercise rights.
"""
import os
import sys
...
def main(d=3, L=3, print_progress=True, steps=9, r=0.05, delta_dividend=0.1, T=3, traj_est=80000, grid=100, mode_kaggle=False, traj_test_lb=150000, traj_test_ub=10000, K_low=200, K_up=100, K_noise=None,S_0=110, strike=100, seed=0, step_size=None, payoff_=lambda x, strike: utils.payoff_maxcal(x, strike), seed_traj_testingALL_add=0):
    """
    Main function, which executes slightly adjusted Schoenmakers et al. (2013) approach. LongstaffSchwartz LSMC is used rather than Tsisikilis & van Roy.
