...
def main(d=1,print_progress=True, steps= 100, traj_est=80000, grid=100, step_inner=True, traj_test_lb=150000, traj_test_ub=10000, K_low=200, K_up=10, hurst=0.7, seed=0, mode_kaggle=False, lambda_=1, L=1):
    time_training=[]
    time_testing=[]
    time_ub=[]
    ...
    for d,H in [ (2,0.2), (1,0.3), (1, 0.7)]:
        for grid in [100]:
            ...
            for i in range(1):                
                ...
                list_inf=main(d, True, grid=grid, K_low=200,K_up=50, traj_est=100000, traj_test_ub=40000, traj_test_lb=50000, hurst=H, seed=i+8, steps=9, lambda_=1/2)
                label_='HK LS'
                inf_cols = [d, H, '', '', '', '']
