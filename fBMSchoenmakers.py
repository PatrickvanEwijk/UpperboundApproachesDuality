"""
File which executes Belomestny (2013) programming pure dual upper bound approaches to a fractional brownian motion.
"""
import os
...
def main(d=1,print_progress=True,steps= 100, T=1, traj_est=80000, grid=100, step_inner=True, traj_test_lb=150000, traj_test_ub=10000, K_low=200, K_up=10, hurst=0.7, seed=0, mode_kaggle=False, seed_traj_testingALL_add=0):
    """
