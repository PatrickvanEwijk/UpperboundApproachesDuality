from tensorflow import keras, random, constant_initializer, compat, Variable, multiply, nn
import os,sys
...
class model_fBm():
    ...
    random_basis_LS_noise= lambda self, x, time:  self.models_ub_noise[time](x, training=False).numpy() if self.K_noise is not None else None
