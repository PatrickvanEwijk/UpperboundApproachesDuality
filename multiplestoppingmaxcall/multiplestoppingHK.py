...
def main(d=3, L=3, print_progress=True, steps=9,T=3, delta_dividend=0.1, traj_est=80000, grid=100, mode_kaggle=False, traj_test_lb=150000, traj_test_ub=10000, K_low=200, K_noise=10, S_0=110, strike=100, seed=0, payoff_=lambda x, strike: utils.payoff_maxcal(x, strike)):
    time_training=[]
    time_testing=[]
    time_ub=[]
    ...
    model_ = model_HaughKaugen(model_nn_rng, seed, input_size_lb, K_lower, steps, d, 0, input_size_ub, L=L, K_noise=K_noise, mode_kaggle=mode_kaggle)
